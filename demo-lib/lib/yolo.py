...
"""
def perform_object_detection(url = 'https://imgcdn.cna.com.tw/Eng/WebEngPhotos/800/2025/20250527/1024x698_763747498679.jpg'):
    ...
    参数详解
        show=True 显示检测结果图片
        save=True 保存检测结果图片，会创建 runs 文件夹
    """
    model(url, show=True, save=True)
